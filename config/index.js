...
module.exports = {
	...
	TXT: {
		...
		SEARCH: {
			...
			SEARCH_FOR_HOUSES:
				'Search for houses and flats for sale across the UK'
		}
	},
	API_KEY: {
	...
	URL: {
		API: {
			...
			FT_RECOMMENDATIONS_USERS:
				process.env.FT_RECOMMENDATIONS_USERS_API_URL,
			FT_SESSIONS: process.env.FT_SESSIONS_API_URL,
			SIX_DEGREES_MENTIONED:
				process.env.API_URL_SIX_DEGREES + 'mostMentionedPeople',
